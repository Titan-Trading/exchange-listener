...
export default class ChannelManager
{
     ...
     */
    onConnect(callback: (data: {channel: Channel, message: any}) => void)
    {
     ...
     */
    onDisconnect(callback: (data: {channel: Channel, message: any}) => void)
    {
     ...
     */
    onError(callback: (data: {channel: Channel, error: any}) => void)
    {
     ...
     */
    onMessage(callback: (data: {channel: Channel, message: any}) => void)
    {
